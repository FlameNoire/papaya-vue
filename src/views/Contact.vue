        ...
        <transition name="fade">
          <div v-if="showRequestForm" class="make_request">
            ...
            <div class="make_request_wrap">
              ...
              <a v-if="!isMobDevice" href="#" class="close"><img src="@/assets/img/close.svg" alt=" " width="18" @click.prevent="closeRequest"></a>
              <form>
                <input type="text" id="customerName" class="name" :placeholder="$t('pannels.t9')">
                <input type="text" id="customerPhone" class="phone" :placeholder="$t('pannels.t10')">
                <input type="text" id="customerEmail" class="email" :placeholder="$t('pannels.t11')">
                <textarea name="customerMessage" id="customerMessage" :placeholder="$t('pannels.t12')" class="message" style="overflow:hidden"></textarea>
