        ...
        <transition name="fade">
          <div v-if="showRequestForm" class="make_request">
            ...
            <div class="make_request_wrap">
              ...
              <a v-if="!isMobDevice" href="#" class="close"><img src="@/assets/img/close.svg" alt=" " width="18" @click.prevent="closeRequest"></a>
              <form>
                <input v-model="name" type="text" id="customerName" class="name" :placeholder="$t('pannels.t9')">
                <input v-model="phone" type="text" id="customerPhone" class="phone" :placeholder="$t('pannels.t10')">
                <input v-model="email" type="text" id="customerEmail" class="email" :placeholder="$t('pannels.t11')">
                <textarea v-model="message" name="customerMessage" id="customerMessage" :placeholder="$t('pannels.t12')" class="message" style="overflow:hidden"></textarea>
...
export default {
  ...
  methods: {
    ...
    sendRequest() {
      ...
      // const requestForm = document.querySelector('.make_request')
      // const contacts = document.querySelector('.contacts_wrap')
