        ...
        <div v-if="renderServices">
            ...
            <ul class="cat_list">
              <li class="cat_list_tab strategy" @click.prevent="catClick1($event)" @mouseover.stop="catHover($event, services_cats[0].title)">
                ...
                <div class="sub_cats_wrap">
                  <ul>
                    <li v-for="(item, index) in services_cats[0].list" :key="index" @mouseover.stop="catHover($event, item)"><a href="#" @click.prevent>{{item}}</a></li>
                  </ul>
                </div>
              </li>
              <li class="cat_list_tab creative" @click.prevent="catClick2($event)" @mouseover.stop="catHover($event, services_cats[1].title)">
                ...
                <div class="sub_cats_wrap">
                  <ul>
                    <li v-for="(item, index) in services_cats[1].list" :key="index" @mouseover.stop="catHover($event, item)"><a href="#" @click.prevent>{{item}}</a></li>
                  </ul>
                </div>
              </li>
              <li class="cat_list_tab technology" @click.prevent="catClick3($event)" @mouseover.stop="catHover($event, services_cats[2].title)">
                ...
                <div class="sub_cats_wrap">
                  <ul>
                    <li v-for="(item, index) in services_cats[2].list" :key="index" @mouseover.stop="catHover($event, item)"><a href="#" @click.prevent>{{item}}</a></li>
                  </ul>
                </div>
              </li>
            </ul>
          ...
          <div v-else class="categories mob">
            ...
            <ul class="cat_list">
              <li v-for="(cat, index) in services_cats" :key="cat.title" class="cat_list_tab strategy" :class="{'active' : index == activeTab}" @click.prevent="catClickHandler($event, index)">
                <a @click.prevent href="#" class="cats">
                  ...
                  <transition @after-enter="openTab" @leave="closeTab" appear>
                    ...
                    <ul>
                      <li v-for="(item, index) in cat.list" :key="index"><a href="#">{{item}}</a></li>
                    </ul>
                    </div>
                  </transition>
                
              </li>
              <!-- <li class="cat_list_tab creative" @click="catClickHandler($event)">
                <a href="#" class="cats">
                  <span class="cat_icon"><img src="@/assets/img/design.svg" alt=" "></span>
                  <span class="cat_text">CREATIVE</span>
                </a>
                <div class="sub_cats_wrap">
                  <ul>
                  </ul>
              ...
              <li class="cat_list_tab technology" @click="catClickHandler($event)">
                <a href="#" class="cats">
                  <span class="cat_icon"><img src="@/assets/img/code.svg" alt=" "></span>
                  <span class="cat_text">TECHNOLOGY</span>
                </a>
                <div class="sub_cats_wrap">
                  <ul>
                  </ul>
